  ...
  return (
    <div className="placeholder-shell">
      <div className="placeholder-card">
        ...
        {/* Visual Badge Icon */}
        <div className="w-16 h-16 rounded-full bg-primary-fixed text-primary flex items-center justify-center mt-2">
        ...
        <div className="space-y-2">
          ...
          <p className="font-body-md text-on-surface-variant max-w-sm mx-auto leading-relaxed">
            Your institutional cultural engagement workspace is coming soon.
          </p>
        </div>
